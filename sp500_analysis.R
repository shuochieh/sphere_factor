...
cos_dist = array(NA, dim = c(q, 4, 36))
...
for (m in 1:36) {
  ...
  for (k in 1:q) {
    ...
    temp = eigen(Sigma_hat)
    v = as.matrix(temp$vectors[,1:k])
    cos_dist[k,4,m] = subspace_d(v, truth$vectors[,1:k])
    if (k == 1) {
...
for (k in c(1:3)) {
  ...
  points(x_dates, cos_dist[k,3,], pch = 23, col = "darkseagreen1",
         bg = "darkseagreen1")
  lines(x_dates, cos_dist[k,4,], col = "mediumpurple4", lwd = 1.5, lty = 6)
  points(x_dates, cos_dist[k,4,], pch = 15, col = "mediumpurple1",
         bg = "mediumpurple1")
  ...
  if (k == 1) {
    legend("bottomright",
           legend = c(paste0("RFM (Mean = ", round(rowMeans(cos_dist[k,,])[1], 2), ")"), 
                      ...
                      paste0("EWMA (Mean = ", round(rowMeans(cos_dist[k,,])[4], 2), ")")),
    ...
    legend("bottomright",
           legend = c(paste0("RFM (Mean = ", round(rowMeans(cos_dist[k,,])[1], 2), ")"), 
                      ...
                      paste0("LOCF (Mean = ", round(rowMeans(cos_dist[k,,])[3], 2), ")"),
                      paste0("EWMA (Mean = ", round(rowMeans(cos_dist[k,,])[4], 2), ")")),
           col = c("lightblue", "lightsalmon", "darkseagreen1", "mediumpurple1"),
           lty = c(1, 2, 4, 6), lwd = 0.01,
           pch = c(19, 17, 23, 15), bty = "n",
           pt.bg = c(NULL, NULL, "darkseagreen1", NULL))
  } else {
    legend("bottomright",
           legend = c(paste0("RFM (Mean = ", round(rowMeans(cos_dist[k,,])[1], 2), ")"), 
                      paste0("LFM (Mean = ", round(rowMeans(cos_dist[k,,])[2], 2), ")"), 
...
legend("bottomright",
       legend = c(paste0("RFM (Mean = ", round(rowMeans(sqrt(BWS_errors))[1], 2), "; Median = ", round(median(sqrt(BWS_errors[1,])), 2), ")"), 
                  ...
                  paste0("EWMA (Mean = ", round(rowMeans(sqrt(BWS_errors))[4], 2), "; Median = ", round(median(sqrt(BWS_errors[4,])), 2), ")")),
       col = c("steelblue", "firebrick", "darkseagreen4", "mediumpurple4"),
       lty = c(1, 2, 4, 6), lwd = c(2, 1.5, 1.5, 1.5), bty = "n",
       cex = 0.8)
legend("bottomright",
...
legend("topright",
       legend = c(paste0("RFM (Mean = ", round(rowMeans(Euc_errors)[1], 2), "; Median = ", round(median(Euc_errors[1,]), 2), ")"), 
                  paste0("LFM (Mean = ", round(rowMeans(Euc_errors)[2], 2), "; Median = ", round(median(Euc_errors[2,]), 2), ")"), 
                  paste0("LOCF (Mean = ", round(rowMeans(Euc_errors)[3], 2), "; Median = ", round(median(Euc_errors[3,]), 2), ")"),
                  paste0("EWMA (Mean = ", round(rowMeans(Euc_errors)[4], 2), "; Median = ", round(median(Euc_errors[4,]), 2), ")")),
       col = c("steelblue", "firebrick", "darkseagreen4", "mediumpurple4"),
       lty = c(1, 2, 4, 6), lwd = c(2, 1.5, 1.5, 1.5), bty = "n",
       cex = 0.8)
legend("topright",
...
legend("topright",
       legend = c(paste0("RFM (Mean = ", round(mean(risk_error[1,]), 2), "; Median = ", round(median(risk_error[1,]), 2), ")"), 
                  ...
                  paste0("EWMA (Mean = ", round(mean(risk_error[4,]), 2), "; Median = ", round(median(risk_error[4,]), 2), ")")),
       col = c("steelblue", "firebrick", "darkseagreen4", "mediumpurple4"),
       lty = c(1, 2, 4, 6), lwd = c(2, 1.5, 1.5, 1.5), bty = "n",
       cex = 0.8)
legend("topright",
       ...
       lty = c(1, 2, 4, 6), lwd = 0.00,
       pch = c(19, 17, 23, 15), bty = "n",
       col = c("steelblue", "firebrick", "darkseagreen4", "mediumpurple1"),
       pt.bg = c(NULL, NULL, "darkseagreen1", NULL),
       cex = 0.8)
